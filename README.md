<p align="center">
  <img src="./banner.png" alt="Omkar Jaliparthi — Product & Program Leader · AI Platform Founder" width="100%" />
</p>
...
**Standouts:** two-stage AI content governance (Chandra + Surya → Brahma + Vishnu + Shiva, dual-model consensus) · chargeback defense baked into receipts, admin, and agent context · multi-tier AI support (6 Tier-1 + Tier-2 escalation) · atomic credit architecture with automatic refund

→ [Live product](https://www.insightsbyomkar.com) · [Case study](https://github.com/omkarjaliparthi/insights-by-omkar-case-study)
...
**Product** — 0→1 discovery · API product design · structured-output AI UX · pricing & packaging · developer experience
**Program** — versioned releases · pre-launch governance · incident response · cross-functional orchestration · roadmap ops
**Engineering** — full-stack TS/Next.js · Supabase + RLS · payment webhooks · multi-provider AI · first-principles systems
...
<p align="center">
<b>Open to Senior PM · TPM · Founding PM · Founding TPM roles</b><br/>
<sub>AI platforms · Developer tools · API platforms · Agentic AI · Infra · Consumer · Fintech · Healthtech · B2B SaaS · Data</sub><br/>
<sub>Based in San Jose, CA · Open to relocate anywhere in the US · Remote or hybrid</sub>
</p>
